...
Напишите скрипт *part1.sql*, создающий базу данных и все таблицы, описанные выше. Можно воспользоваться уже готовым датасетом, доступным по [ссылке](https://disk.yandex.ru/d/aD9ynYOYvhs6Ig).
